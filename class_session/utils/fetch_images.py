...
def get(request, pk, obj, i):
    ...
    if obj == "lecture":
        ...
        try:
            main_obj = Lecture.objects.prefetch_related('images').get(pk=i)
        ...
        try:
            main_obj = Submission.objects.prefetch_related('images').get(pk=i)
        ...
        try:
            main_obj = Assignment.objects.prefetch_related('images').get(pk=i)
        except Submission.DoesNotExist:
            return {
